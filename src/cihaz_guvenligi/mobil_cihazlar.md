...
* **Orta Risk**: An itibari ile hedef değilken bir saldırganın cihazlarınıza fiziksel erişim sağlaması durumunda kolay lokma olmayı tercih etmiyorsanız.
...
Bu sebeple riskinizin düşük olduğuna eminseniz ve yanıldığınız için pişman olmayacaksanız, pekala herhangi bir telefon alıp sadece ekran kilidi bile kullanmadan hayatınızı sürdürebilirsiniz.
